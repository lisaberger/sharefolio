...
<template>
    <router-link
        ...
        class="border-surface-200 group flex w-full flex-col overflow-hidden rounded-xl border bg-white shadow-xs transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
    >
