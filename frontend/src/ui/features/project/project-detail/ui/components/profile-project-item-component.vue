...
<template>
    <router-link
        ...
        class="border-surface-200 group flex w-full flex-col overflow-hidden rounded-xl border bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
    >
        <div class="relative h-44 overflow-hidden">
            ...
            <span
                ...
                class="bg-primary-500 absolute left-3 top-3 rounded-full px-3 py-1 text-xs font-semibold text-white"
            >
                {{ props.project.kind }}
            </span>
        </div>
