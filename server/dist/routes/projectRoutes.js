...
import { createProject, getProjectByName, getProjects, } from '../controllers/projectController.js';
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/create', requireAuth, projectUpload.array('pics'), createProject);
